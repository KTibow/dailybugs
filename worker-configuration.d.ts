/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6daa96444a389bf07827e8062e25fe91)
...
declare namespace Cloudflare {
	...
	interface Env {
		KV: KVNamespace;
		ASSETS: Fetcher;
		GITHUB_CLIENT_ID: "Ov23liZ42ZbwqopYT7Y6";
		GITHUB_CLIENT_SECRET: string;
		HCAI_KEY: string;
		RESEND_KEY: string;
		DISCORD_WEBHOOK: string;
		JWT_SECRET: string;
		WORKFLOW: Workflow<Parameters<import("./src/index").BugWorkflow['run']>[0]['payload']>;
	}
}
